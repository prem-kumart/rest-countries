...
return (
    ...
    <div className="flex  justify-center items-center  bg-white font-Nunito-sans text-Dark-Blue shadow-button-sm min-w-[96px] min-h-[28px] rounded-[2px] px-1.5 py-2 ">
